...
const WorkExperience = () => {
  ...
  return (
    <section ref={experienceRef} className="py-20 px-6 bg-gradient-secondary">
            ...
            >
              <CardContent className="p-8">
                <div className="flex flex-col sm:flex-row items-start gap-6">
                  <div className="w-20 h-20 bg-primary/20 rounded-full flex items-center justify-center hover:bg-primary/30 transition-colors duration-300 overflow-hidden shrink-0">
                    {item.logo ? (
                      <img
                        src={item.logo}
